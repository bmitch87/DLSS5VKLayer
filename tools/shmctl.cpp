...
const Setting kSettings[] = {
    ...
    { "shadowgain", &ShmHeader::shadowGainBits, true,
      "how much of the model's DARKENING reaches the frame, 0-4; 1 is all of it" },
    { "glowgain", &ShmHeader::glowGainBits, true,
      "how much of its BRIGHTENING reaches the frame, 0-4; 1 is all of it" },
